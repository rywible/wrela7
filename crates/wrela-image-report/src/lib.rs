...
const CURRENT_MACHINE_WIR_VERSION: u32 = 10;
...
mod tests {
    ...
    use super::{
        ...
        ProofFact, RegionCapacityEvidenceFact, ReportError, SectionFact, SymbolFact,
        ValidatedAnalysisFacts, WorkFact, cancellable_sort, decode_image_report_json,
    ...
    fn actor_task_region_graph_is_canonical_bounded_and_cancellable() {
        ...
        assert_eq!(super::REPORT_SCHEMA_VERSION, 11);
        ...
        .expect("schema-v11 activation report");
        ...
        assert_eq!(
            ...
            .expect("decode exact schema-v11 activation evidence"),
            report
        );
    ...
    fn every_non_current_representation_version_fails_closed() {
        ...
        let mutations: [fn(&mut super::RepresentationFacts); 10] = [
            ...
            |versions| versions.machine_wir_version = 7,
            |versions| versions.machine_wir_version = 9,
